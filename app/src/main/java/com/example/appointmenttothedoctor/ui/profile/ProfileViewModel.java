        ...
        usersChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (userProfile.getId().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                    ...
                    image.setValue("https://firebasestorage.googleapis.com/v0/b/appointment-to-the-docto-129cb.appspot.com/o/image%2F11139.jpg?alt=media&token=043e3934-93bd-45b0-86ed-099165a98089");
                }
            }
